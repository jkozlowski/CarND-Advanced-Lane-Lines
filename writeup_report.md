...
The code for this step is contained in ```Cell 2``` of the IPython notebook located in "./advanced_lane_detection.ipynb" in functions ```calibrate_camera``` and ```undistort_img```.  
